...
public class ChickenBeakFeature<T extends LivingEntity> extends XenotypeFeature<T> {

    private static final ResourceLocation TEXTURE = new ResourceLocation("textures/entity/chicken.png");

    public ChickenBeakFeature(EntityRendererProvider.Context context) {
        super(context, new FeatureModel<>(context.bakeLayer(ModelLayers.CHICKEN_BEAK)));
    }
    ...
    public static LayerDefinition createLayer() {
        ...
        root.addOrReplaceChild(HumanoidPart.HEAD.partName, CubeListBuilder.create()
                        .texOffs(14, 0).addBox(-2.0F, -3.0F, -6.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                        .texOffs(14, 4).addBox(-1.0F, -1.0F, -5.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
