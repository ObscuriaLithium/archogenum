...
public interface ArchoItems {
    ...
    DeferredItem<EchoVesselItem> ECHO_VESSEL = create("echo_vessel", () -> new EchoVesselItem(new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    DeferredItem<MusicDiscItem> MUSIC_DISC = create("music_disc", () -> new MusicDiscItem(6, ArchoSounds.MUSIC_DISC, new Item.Properties().stacksTo(1).rarity(Rarity.EPIC), 150));
