...
public interface ITrait {
    ...
    default double exposureTo(DamageSource source) {
        return 0.0;
    }
    ...
    default boolean canStandOnFluid(FluidState state) {
        return false;
    }
    ...
    default void appendComponents(Holder<ITrait> self, Consumer<TraitComponent> consumer) {
        ...
        consumer.accept(new TraitComponent(defaultCategory(), Component.translatable(key)));
    }

    default GeneCategory defaultCategory() {
        return GeneCategory.BENEFICIAL;
    }
    ...
    static void bootstrap(BootstrapContext<Codec<? extends ITrait>> context) {
        ...
        context.register("damage_exposure", () -> DamageExposureTrait.CODEC);
    }
}
